...
- 1x backplate
- 2x front-plate
- 2x connecting rod left
- 2x connecting rod right
- 1x back-plane PCB
...
=== Attaching the backplane covers 
If the cluster frame is able to power all the PI nodes, the back-plane covers can be placed.

For every back-plane you need a cover
Fro every back-plane cover you need 4x M3x30 screw
