...
The 3D printed parts needed to complete one half of the frame are shown in the picture below:

image::cras.jpg["Buildimage",{fullWidth},{fullHeight}]

NOTE: During development a back-plane shim is used, shown on the picture. This is no longer needed.
